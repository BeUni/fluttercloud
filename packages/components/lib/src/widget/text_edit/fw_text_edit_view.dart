...
class FwTextEditView extends StatefulWidget {
  final String text;
  ...
  const FwTextEditView({super.key,
    required this.text,
    this.controller,
  ...
  @override
  State<FwTextEditView> createState() => _FwTextEditViewState();
}

class _FwTextEditViewState extends State<FwTextEditView> {
